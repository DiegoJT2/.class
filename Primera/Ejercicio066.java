/*
Modificar la frase de manera que cada palabra desplace sus letras una posición a la derecha y la última letra se coloque en la primera posición.
 */
package Primera;

public class Ejercicio066 {
    public static void main (String arg[]){
        char frase[]={'E', 'n', 'Y', 'u', 'n', ' ', 'l', 'u', 'g', 'a', 'r', ' ', 'd', 'e', ' ', 'L', 'a', ' ', 'M', 'a', 'n', 'c', 'h', 'a', ' '};
        int inicio,fin;
        inicio=fin=0;
